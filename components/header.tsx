  ...
  <div className="container mx-auto px-8 py-5">
    <div className="flex items-center justify-between">
      ...
      <nav className="flex items-center space-x-10 w-1/3 min-w-[400px]">
        <Link href="/blog" className={`text-sm font-medium transition-colors duration-200 ${isActive('/blog') ? 'text-green-600 font-semibold' : 'text-gray-700 hover:text-green-600'}`}>
          Blog
        </Link>
        <Link href="/cardapio" className={`text-sm font-medium transition-colors duration-200 ${isActive('/cardapio') ? 'text-green-600 font-semibold' : 'text-gray-700 hover:text-green-600'}`}>
          Cardápio
        </Link>
        <Link href="/entregas" className={`text-sm font-medium transition-colors duration-200 ${isActive('/entregas') ? 'text-green-600 font-semibold' : 'text-gray-700 hover:text-green-600'}`}>
          Entregas
        </Link>
      </nav>
      ...
      <nav className="flex items-center space-x-10 w-1/3 min-w-[400px] justify-end">
        <Link href="/sobre" className={`text-sm font-medium transition-colors duration-200 ${isActive('/sobre') ? 'text-green-600 font-semibold' : 'text-gray-700 hover:text-green-600'}`}>
          Sobre nós
        </Link>
        <Link href="/contato" className={`text-sm font-medium transition-colors duration-200 ${isActive('/contato') ? 'text-green-600 font-semibold' : 'text-gray-700 hover:text-green-600'}`}>
          Contato
        </Link>
